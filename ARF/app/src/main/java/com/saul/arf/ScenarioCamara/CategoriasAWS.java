...
public class CategoriasAWS extends AsyncTask<Void,Void,String> {
    ...
    public CategoriasAWS(int id_user, int id_proyecto, Escenario escenario, Activity activity, Context context) {
    ...
    protected void onPostExecute(String cad){
        MueblesAWS mueblesAWS=new MueblesAWS(id_user,id_proyecto,escenario,activity,context,cad);
        mueblesAWS.execute();
    }
}
