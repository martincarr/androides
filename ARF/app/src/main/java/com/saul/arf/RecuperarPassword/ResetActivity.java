...
public class ResetActivity extends AppCompatActivity {
    ...
    /*public static String getEmailUser() {
        String correoUser = ResetActivity.getEmailUser();
        return correoUser;
    }

    public static void setEmailUser(String emailUser) {
        ResetActivity.emailUser = emailUser;
    }
    public static void setMensaje(String mensaje){
        ResetActivity.mensaje = mensaje;
    }

    public static String getMensaje(){
        String mensaje_peticion = ResetActivity.mensaje;
        return mensaje_peticion;
    }*/
